...
export declare interface FhevmInstance {
    ...
    createEIP712(publicKey: string, contractAddresses: string[], startTimestamp: number, durationDays: number, extraData: BytesHex): KmsUserDecryptEIP712Type;
    createDelegatedUserDecryptEIP712(publicKey: string, contractAddresses: string[], delegatorAddress: string, startTimestamp: number, durationDays: number, extraData: BytesHex): KmsDelegatedUserDecryptEIP712Type;
    publicDecrypt(handles: (string | Uint8Array)[], options?: RelayerPublicDecryptOptionsType): Promise<PublicDecryptResults>;
    userDecrypt(handles: HandleContractPair[], privateKey: string, publicKey: string, signature: string, contractAddresses: string[], userAddress: string, startTimestamp: number, durationDays: number, extraData: BytesHex, options?: RelayerUserDecryptOptionsType): Promise<UserDecryptResults>;
    delegatedUserDecrypt(handleContractPairs: HandleContractPair[], privateKey: string, publicKey: string, signature: string, contractAddresses: string[], delegatorAddress: string, delegateAddress: string, startTimestamp: number, durationDays: number, extraData: BytesHex, options?: RelayerUserDecryptOptionsType): Promise<UserDecryptResults>;
    getPublicKey(): {
        publicKeyId: string;
